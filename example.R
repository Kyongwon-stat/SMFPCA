...
X[,,5]=X[,,1]+X[,,2]+X[,,4]+rnorm(n*ntx, sd=.5)
...
Z <- groupsparsePCA(x,m=5,c(0.7,0.7,0.7,0.7,0.7),index)$Z 
res.plot1 <- fd(Z[c(1:5),c(1:3)],databasis)
res.plot2 <- fd(Z[c(6:10),c(1:3)],databasis)
res.plot3 <- fd(Z[c(11:15),c(1:3)],databasis)
res.plot4 <- fd(Z[c(16:20),c(1:3)],databasis)
res.plot5 <- fd(Z[c(21:25),c(1:3)],databasis)
par(mfrow=c(3,5))
plot(res.plot1)
title("i=1")
plot(res.plot2)
